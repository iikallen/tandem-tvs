...
`PROFILE=smoke` is 8 VUs for one minute. The full mixed profile holds 180 browse/search users,
90 Messenger HTTP users, and 30 realtime users for 30 minutes. The capacity profile opens 300
